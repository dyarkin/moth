...
- `manifest.yaml` -- description of the module, like types of templates (housing/tenant), whether certain files should be disabled with certain variables values, etc.
...
- `.compiled` -- final compiled templates of the module, before they are copied to the tool's root dir `.compiled`.
- `.config.yaml` — all temporary values, like currently enabled presets [MAKE UP DIFFERENT NAME]
